...
```sh
python3 -m verification.async_split_prototype --steps 1 --control-pcm -75 --control-time-s 1 --json
python3 -m verification.reactivity_sweep --quick --case-pcm 0,-75 --insertion-time-s 1
python3 -m verification.generate_evaluation_figures --quick case_00_steady_state_reference
```

New generated outputs should go under `verification/outputs/`, which
is ignored by Git.
