...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--out-dir",
        type=Path,
        default=FPGA_EMULATION_DIR / "analysis_artifacts" / "fpga_compare_20260617",
    )
    parser.add_argument("--cpu-runner-src", type=Path, default=FPGA_EMULATION_DIR / "vcu118" / "msr_vcu118_sw_timed.cpp")
