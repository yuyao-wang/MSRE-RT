# FPGA Emulation And VCU118 Runtime
...
HLS synthesis scripts remain under `fpga_emulation/hls_modules/`.
...
The C++ files in `fpga_emulation/vcu118/` are low-level timing runners that consume
