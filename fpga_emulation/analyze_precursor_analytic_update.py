...
def compile_runner(binary_path: Path, analytic: bool) -> None:
    cmd = [
        ...
        str(FPGA_EMULATION_DIR / "vcu118" / "msr_vcu118_sw_timed.cpp"),
        "-o",
        str(binary_path),
    ]
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--out-dir", type=Path, default=FPGA_EMULATION_DIR / "analysis_artifacts" / "precursor_analytic_update_20260618")
