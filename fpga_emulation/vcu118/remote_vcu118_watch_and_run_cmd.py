...
DEFAULT_LOCAL_OUT_ROOT = FPGA_EMULATION_DIR / "analysis_artifacts" / "remote_vcu118_board_runs_cmd"
...
def decode_final_diagnostics(input_path: Path) -> dict[str, object]:
    result = run_command([
        sys.executable,
        str(FPGA_EMULATION_DIR / "vcu118" / "msr_transient_batch_vcu118_host.py"),
