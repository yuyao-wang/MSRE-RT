...
See
`fpga_emulation/analysis_artifacts/fpga_compare_20260617/report.md`
for the timing and readback comparison that feeds this table.

## Synthesis Reports

The curated synthesis reports under `docs/synthesis_reports/` include
`csynth` reports, schedule XML, design XML, schedule diagrams, and extracted
report bundles.

## Board Evidence

README hardware figures are stored under `docs/readme_assets/`.
