...
| [`docs/hardware_mapping.md`](docs/hardware_mapping.md) | C++17 hardware mapping and pre-FPGA verification role |
| [`docs/hardware_mapping_to_fpga.md`](docs/hardware_mapping_to_fpga.md) | Mapping from the software implementation to FPGA kernels |
